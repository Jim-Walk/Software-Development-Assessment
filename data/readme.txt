Version 6.0 Produced 2018-06-21

National Student Survey 2017

Notes on the use of the data

Following a major review, the National Student Survey was substantially revised in 2017. These were the first major changes to the survey since its establishment in 2005.

The 2017 survey therefore used a different main questionnaire from that used in previous years. The 2018 survey uses the same questionnaire as that used in 2017.
...
•	Question level aggregation: Question level responses from data from 2017 should not be directly aggregated with (compiled together with) data from previous years with no statistical adjustment made for the differences in the dataset.

•	Comparison of data:  It is not valid to compare question level responses from 2017 with data from previous years and such comparisons should not be undertaken.
...
Where 2018 NSS data on the Unistats web-site does not meet customary publication response thresholds (50% of the sample responding and at least 10 students), data will be aggregated with 2017 data to meet this threshold.
Where the aggregated data from 2017/18 still does not meet customary publication response thresholds, data is aggregated on the basis of a higher level subject grouping.

Where there is insufficient data to meet publication thresholds, the following message will appear on the Unistats web-site. 
...
The Unistats.csv files have been included in this folder to enable users to load .csv versions of the kis.xml file entities into their databases for analysis.
...
https://www.hesa.ac.uk/collection/c18061/unistats_dataset_file_structure/
...
LEO.csv,
LEO entity,
Contains Longitudinal Education Outcomes salary data,
Linked to KISCOURSE entity using PUBUKPRN, KISCOURSEID and KISMODE
